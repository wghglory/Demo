<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListView变色.aspx.cs" Inherits="Ajax.CRUD.UI.test1._1" %>
...
<body>
    ...
    <div>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DataObjectTypeName="Ajax.CRUD.Model.Aspx_Students"
            DeleteMethod="DeleteByStuId" InsertMethod="Add" SelectMethod="GetAllStudents"
            TypeName="Ajax.CRUD.BLL.Aspx_StudentsBll" UpdateMethod="Update">
            <DeleteParameters>
                <asp:Parameter Name="stuId" Type="Int32" />
            </DeleteParameters>
        </asp:ObjectDataSource>
        <asp:ListView ID="ListView1" runat="server" DataKeyNames="StuId" DataSourceID="ObjectDataSource1"
            InsertItemPosition="LastItem" OnItemDataBound="ListView1_ItemDataBound" OnItemEditing="ListView1_ItemEditing">
            <AlternatingItemTemplate>
                <tr style="background-color: #FFF8DC; color: Blue;">
                    <td>
                    ...
                    <td>
                        <asp:Label ID="StuBirthdayLabel" runat="server" Text='<%# Eval("StuBirthday") %>' />
                    </td>
                </tr>
            </AlternatingItemTemplate>
            <EditItemTemplate>
                <tr style="background-color: #008A8C; color: #FFFFFF;">
                    ...
                    <td>
                        <asp:TextBox BackColor="Yellow" ID="StuIdTextBox" runat="server" Text='<%# Bind("StuId") %>' />
                    </td>
                    <td>
                    ...
                    <td>
                        <asp:DropDownList runat="server" ID="DDLGender" SelectedValue='<%# Bind("StuGender") %>'>
                    ...
                    <td>
                        <asp:TextBox ID="StuEmailTextBox" runat="server" Text='<%# Bind("StuEmail") %>' />
                    </td>
                    <td>
            ...
            <ItemTemplate>
                <tr style="background-color: #DCDCDC; color: #ff0000;">
                    <td>
                        <asp:Button ID="DeleteButton" runat="server" CommandName="Delete" Text="删除" />
                        <asp:Button ID="EditButton" runat="server" CommandName="Edit" Text="编辑" />
                    </td>
