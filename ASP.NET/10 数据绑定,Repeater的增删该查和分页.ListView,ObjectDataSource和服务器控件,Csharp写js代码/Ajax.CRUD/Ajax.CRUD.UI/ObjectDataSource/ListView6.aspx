<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListView6.aspx.cs" Inherits="Ajax.CRUD.UI._20130808.ListViewDemo.WebForm1" %>
...
<body style="font: 12px 宋体;">
    ...
    <div>
        ...
        <asp:ListView ID="ListView1" runat="server" DataSourceID="ObjectDataSource1" InsertItemPosition="LastItem"
            DataKeyNames="StuId" ItemPlaceholderID="xxxxx">
            ...
            <EditItemTemplate>
                <tr style="background-color: #008A8C; color: #FFFFFF;">
                    ...
                    <td>
                        <asp:TextBox ReadOnly="true" ID="StuIdTextBox" runat="server" Text='<%# Bind("StuId") %>' />
                    </td>
                    <td>
                    ...
                    <td>
                        <asp:DropDownList ID="DropDownList1" SelectedValue='<%# Bind("StuGender") %>' runat="server">
