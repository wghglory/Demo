...
namespace AjaxComment.UI.ProviceCity
{
    /// <summary>
    /// Summary description for GetAreaByParentId
    /// </summary>
    public class GetAreaByParentId : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (pid != null)
            {
                ...
                IEnumerable<TblArea> _list = bll.GetAreasByParentId(int.Parse(pid));
                List<TblArea> list = _list.ToList<TblArea>();
                ...
                var _areaData = new { SelectedId = list[7].AreaId, AreaJsonData = _list };
