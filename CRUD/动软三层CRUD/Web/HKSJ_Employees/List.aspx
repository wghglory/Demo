<%@ Page Title="HKSJ_Employees" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="MaticSoft.Web.HKSJ_Employees.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="MainPeople" HeaderText="MainPeople" SortExpression="MainPeople" ItemStyle-HorizontalAlign="Center"  /> 
