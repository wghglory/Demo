...
namespace MaticSoft.DAL
{
	...
	public partial class HKSJ_Employees
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(MaticSoft.Model.HKSJ_Employees model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MaticSoft.Model.HKSJ_Employees model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public MaticSoft.Model.HKSJ_Employees GetModel(int ID)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public MaticSoft.Model.HKSJ_Employees DataRowToModel(DataRow row)
		{
			MaticSoft.Model.HKSJ_Employees model=new MaticSoft.Model.HKSJ_Employees();
			if (row != null)
			{
