...
namespace MaticSoft.DAL
{
	...
	public partial class HKSJ_Relationship
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(MaticSoft.Model.HKSJ_Relationship model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MaticSoft.Model.HKSJ_Relationship model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public MaticSoft.Model.HKSJ_Relationship GetModel(int ID)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public MaticSoft.Model.HKSJ_Relationship DataRowToModel(DataRow row)
		{
			MaticSoft.Model.HKSJ_Relationship model=new MaticSoft.Model.HKSJ_Relationship();
			if (row != null)
			{
