  ...
  public class FilterHelper
    {
      ...
      public static void CreateFilterGroup(FilterGroup group, List<FilterGroup> filterGroups, string fieldName, object keyName, GroupOperatorQueryEnum groupOp, RuleOperatorQueryEnum ruleOp)
      {
          group.groups = filterGroups;
          group.op = groupOp;
          if (group.rules == null)
          {
              group.rules = new List<FilterRule>();
          }
          group.rules.Add(new FilterRule(fieldName, keyName, ruleOp));
      }
    }
}
